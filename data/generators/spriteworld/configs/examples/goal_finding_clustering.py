...
def get_config(mode="train"):
    ...
    sprite_gen_list = []
    cluster_shapes = [
        distribs.Discrete("shape", [s]) for s in ["triangle", "square", "pentagon"]
    ]
    ...
    goal_finding_positions = [(0.0, 0.5), (1.0, 0.5)]
    ...
    task_list = []
    task_list.append(
        tasks.Clustering(cluster_shapes, terminate_bonus=0.0, reward_range=10.0)
    )
    ...
    renderers = {
        "image": spriteworld_renderers.PILRenderer(image_size=(64, 64), anti_aliasing=5)
    }
